...
　    '財務実績分析_メッセージ_',        
    ...
    // ★追加：コピーしないプレフィックス
    noCopyPrefixes: new Set(['財務実績分析', '全銘柄基本情報取得', '全銘柄四季報情報取得', '証券コード取得', 'カレンダー取得', '四季報情報更新監視', '指数日足取得', '全銘柄日足取得', '全銘柄信用取引残高取得', '全銘柄日足分析', '市況関連データ抽出_ALL', '市況関連データ抽出_GROUP1', '市況関連データ抽出＃経済スケジュール']),
    // ★追加：マスタ更新するプレフィックス
